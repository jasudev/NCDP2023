    ...
    var body: some View {
        GeometryReader { geo in
            HStack(alignment: .top, spacing: 0) {
                ...
                FoldedShapeTitleSetView(data: TitleSetData(title: "Auxiliary(보조 효과)", subtitle: ".transition,\n.matchedGeometryEffect\n수정자로 적용"), size: CGSize(width: 280, height: 190), fillColor: Color.primaryLevel6, outlineColor: indexValue >= 7 ? Color.pointYellow : Color.primaryLevel5, lineWidth: 1)
        ...
        .padding(.horizontal, store.contentSize.width * 0.08)
